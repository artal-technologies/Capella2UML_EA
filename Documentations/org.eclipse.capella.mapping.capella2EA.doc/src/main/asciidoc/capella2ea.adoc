...
For check the dropin installation, check the Model transformation menu is available as it is describes in the <<Open Contextual "Model transformation" menu>> section. 
