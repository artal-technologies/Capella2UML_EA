 ...
 * </p>
 * <ul>
 *   <li>{@link xmi.impl.PackagedElementImpl#getXmiid <em>Xmiid</em>}</li>
 *   <li>{@link xmi.impl.PackagedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link xmi.impl.PackagedElementImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link xmi.impl.PackagedElementImpl#getOwnedEnd <em>Owned End</em>}</li>
 *   <li>{@link xmi.impl.PackagedElementImpl#getXmitype <em>Xmitype</em>}</li>
 *   <li>{@link xmi.impl.PackagedElementImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
