 ...
 * </p>
 * <ul>
 *   <li>{@link xmi.impl.umlProfileImpl#getPackagedElement <em>Packaged Element</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getMemberEnd <em>Member End</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getXmiversion <em>Xmiversion</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getXmlnsuml <em>Xmlnsuml</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getXmlnsxmi <em>Xmlnsxmi</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getXmiid <em>Xmiid</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getNsPrefix <em>Ns Prefix</em>}</li>
 *   <li>{@link xmi.impl.umlProfileImpl#getMetamodelReference <em>Metamodel Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
