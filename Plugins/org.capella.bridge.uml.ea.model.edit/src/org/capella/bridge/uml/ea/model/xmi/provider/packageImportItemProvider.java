...
/**
 * This is the item provider adapter for a {@link org.capella.bridge.uml.ea.model.xmi.packageImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class packageImportItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_packageImport_xmiid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_packageImport_xmiid_feature", "_UI_packageImport_type"),
				 XmiPackage.Literals.PACKAGE_IMPORT__XMIID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmiPackage.Literals.PACKAGE_IMPORT__IMPORTED_PACKAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((packageImport)object).getXmiid();
