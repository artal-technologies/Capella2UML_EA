...
/**
 * This is the item provider adapter for a {@link org.capella.bridge.uml.ea.model.xmi.role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class roleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_role_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_role_visibility_feature", "_UI_role_type"),
				 XmiPackage.Literals.ROLE__VISIBILITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((role)object).getVisibility();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(role.class)) {
			case XmiPackage.ROLE__VISIBILITY:
