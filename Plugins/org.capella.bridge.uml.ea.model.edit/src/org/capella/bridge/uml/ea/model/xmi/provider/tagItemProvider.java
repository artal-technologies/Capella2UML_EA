...
/**
 * This is the item provider adapter for a {@link org.capella.bridge.uml.ea.model.xmi.tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_tag_xmiid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_tag_xmiid_feature", "_UI_tag_type"),
				 XmiPackage.Literals.TAG__XMIID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmiPackage.Literals.TAG__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addModelElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_tag_modelElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_tag_modelElement_feature", "_UI_tag_type"),
				 XmiPackage.Literals.TAG__MODEL_ELEMENT,
				 true,
				 false,
				 true,
				 null,
