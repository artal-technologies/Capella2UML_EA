...
/**
 * This is the item provider adapter for a {@link org.capella.bridge.uml.ea.model.xmi.importedPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class importedPackageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_importedPackage_href_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_importedPackage_href_feature", "_UI_importedPackage_type"),
				 XmiPackage.Literals.IMPORTED_PACKAGE__HREF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((importedPackage)object).getHref();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(importedPackage.class)) {
			case XmiPackage.IMPORTED_PACKAGE__HREF:
