 ...
 * </p>
 * <ul>
 *   <li>{@link com.thalesgroup.capella.bridge.uml.ea.model.xmi.impl.operationsImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class operationsImpl extends MinimalEObjectImpl.Container implements operations {
	...
	protected EClass eStaticClass() {
		return XmiPackage.Literals.OPERATIONS;
	}
	...
	public EList<operation> getOperation() {
		if (operation == null) {
			operation = new EObjectContainmentEList<operation>(operation.class, this, XmiPackage.OPERATIONS__OPERATION);
		}
		return operation;
	}
